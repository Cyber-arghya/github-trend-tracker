# aipoch/open-science
**Language:** TypeScript | **Rank:** 14 | **Total Stars:** 3,925
...
| **Literature**               | A project-ready reference library: import references by identifier (DOI, PubMed ID, arXiv ID, and more) or from files, organize them into collections, link them to projects, and route downloaded PDFs through an Inbox with Trash recovery; find and attach full-text PDFs through public open-access sources (Europe PMC, PMC, OpenAlex, arXiv, and Unpaywall), looking up all applicable sources in parallel, with optional credentials; compare duplicate records side by side and bulk-merge them while preserving attachments and links; and format citations from stored metadata with artifact provenance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| **Distribution and support** | Installers for macOS, Windows, and Linux; a streamlined first-run onboarding wizard for environment, data location, agent runtime, model provider, and notebook runtime; interface localization in German, Spanish, French, Chinese (Simplified and Traditional), Japanese, Korean, and Russian with README translations for every supported language and additional multilingual contribution guides; update guidance with prominent update reminders; a headless Task API and CLI with session configuration controls to inspect and update a session's model, memory, and compute-host settings without submitting a prompt; local diagnostics; and community links.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
